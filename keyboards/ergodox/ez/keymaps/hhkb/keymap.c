...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_TRNS,        KC_TRNS,      KC_TRNS,KC_LALT,KC_LGUI,
                                                      KC_HOME,KC_PGUP,
                                                              KC_LALT,
                                               KC_SPC,MO(FUNCS),KC_LALT,
        // right hand
             KC_RBRC,     KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             KC_BSLS,
             S(KC_RBRC),     KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_BSPC,
                          KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,          KC_ENT,
             KC_B,     KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          KC_MINS,
                               KC_RGUI,   KC_TRNS, KC_EQUAL,  KC_TRNS,         KC_QUOT,
             KC_PGDN,     KC_END,
             KC_RALT,
 ...
 * |  Tab   |      |      |      |      |      |MOUSE |           |      | +=   |      |      |   [  |   ]  |   F12  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LCtrl  | VolDn| VolUp| Mute |      |      |------|           |------| Left | Down | Up   | Right|  F12 |  PrSc  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LShift |      |      |      |      |      |      |           |      |MouseL|MouseD|MouseU|MouseR|      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[FUNCS] = KEYMAP(
       ...
       RESET,  KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
                                       KC_TRNS,KC_TRNS,
                                               KC_LALT,
                                KC_SPC,KC_TRNS,KC_LALT,
       // right hand
       KC_TRNS, KC_F6,   KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_F11,
       KC_TRNS, KC_EQUAL, KC_TRNS,KC_TRNS, KC_LBRC, KC_RBRC,  KC_F12,
                KC_LEFT, KC_DOWN,KC_UP, KC_RIGHT, KC_F12,  KC_PSCR,
       KC_TRNS, KC_MS_L, KC_MS_D,KC_MS_U, KC_MS_R, KC_TRNS, KC_TRNS,
                         KC_LEFT,KC_DOWN, KC_UP,   KC_RIGHT,KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_RALT,
       KC_RALT, KC_BTN1, KC_BTN2
),
